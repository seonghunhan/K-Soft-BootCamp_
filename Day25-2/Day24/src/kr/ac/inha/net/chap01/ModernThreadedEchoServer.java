...
public class ModernThreadedEchoServer implements Runnable{
    private static Socket clientSocket;

    public ModernThreadedEchoServer(Socket clientSocket) {
    ...
    public void run() {
        ...
        try(
            ...
            Stream.generate(()-> {
                ...
                System.out.println(Thread.currentThread() + " 클라이언트가 보낸 메세지 : " + i);
